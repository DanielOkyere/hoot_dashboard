        ...
        >
          <Box sx={{ width: '100%', maxWidth: 400 }}>
            ...
            <form noValidate autoComplete='off' onSubmit={e => e.preventDefault()}>
              ...
              <CustomTextField fullWidth label='Company Name' sx={{ mb: 4 }} placeholder='Company name' />
              <CustomTextField fullWidth label='Type Of Business' sx={{ mb: 4 }} placeholder='Type Of Business' />
              <CustomTextField
                fullWidth
                label='Password'
